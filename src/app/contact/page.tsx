  ...
  return (
    <section className="px-6 py-20 md:py-28 min-h-[70vh]">
      <div className="max-w-5xl mx-auto grid md:grid-cols-[1.2fr_0.8fr] gap-16">
        ...
        <div className="md:border-l border-line md:pl-12 flex flex-col justify-center"><div className="rule-gold mb-8" /><p className="chapter-label mb-3">Email</p><a href="mailto:hello@aiformstudio.co.za" className="font-display text-2xl md:text-3xl hover:text-green transition-colors break-all">hello@aiformstudio.co.za</a><div className="border-t border-line mt-9 pt-7"><p className="chapter-label mb-3">Based in</p><p className="text-muted">Pretoria, South Africa</p></div><p className="font-display italic text-xl text-muted mt-12">The best conversations begin with the problem, not the proposed technology.</p></div>
      </div>
    </section>
  );
}
