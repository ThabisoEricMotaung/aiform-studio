...
export default function Home() {
  return <>
    ...
    <section id="studio" className="editorial-grid border-t border-line py-16 md:py-24"><p className="col-span-12 chapter-label md:col-span-2">06 / Founder</p><div className="relative col-span-12 mt-10 aspect-[4/5] md:col-start-3 md:col-span-4 md:mt-0"><Image src="/images/founder.jpg" alt="Thabiso Eric Motaung, founder of AiForm Studio" fill sizes="(max-width:768px) 100vw, 34vw" className="object-cover grayscale" /></div><div className="col-span-12 mt-10 md:col-start-8 md:col-span-5 md:mt-0"><h2 className="section-title">Founder-led. <span className="text-green">Research-driven.</span></h2><p className="mt-8 leading-relaxed text-muted">Founder-led from discovery through delivery. The person understanding the problem stays involved in designing and building the solution.</p><p className="mt-6 leading-relaxed text-muted">AiForm Studio is led by Thabiso Eric Motaung—an academic, researcher and product builder. That combination keeps the work close to how people learn, reason and get stuck.</p></div></section>
    <section className="editorial-grid border-t border-line bg-bg-alt py-12 md:py-16"><p className="col-span-12 chapter-label md:col-span-2">07 / The mark</p><div className="col-span-12 mt-8 flex items-center gap-8 md:col-start-3 md:col-span-8 md:mt-0"><AiFormMark variant="studio" className="h-auto w-24 shrink-0" /><div><h2 className="font-display text-3xl">The mark was noticed before it was designed.</h2><p className="mt-3 leading-relaxed text-muted">Its geometry began with a moth observed on a wall in Pretoria—the “A” was already there.</p></div></div></section>
  </>;
}
