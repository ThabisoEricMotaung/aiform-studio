  ...
  return (
    <header className="flex min-h-20 items-center justify-between border-b border-line bg-bg px-6 md:px-14">
      <Link href="/" aria-label="AiForm Studio home" className="group flex min-h-11 items-center gap-3 focus-visible:outline-offset-2">
        <Image src="/images/aiform-mark.png" alt="" width={472} height={588} sizes="42px" className="h-10 w-auto transition-opacity group-hover:opacity-80 md:h-11" />
        <span className="hidden text-[15px] font-semibold tracking-[.12em] text-text sm:block">AIFORM <span className="font-normal text-muted">/ STUDIO</span></span>
      </Link>
